...
public class Meteor extends MovingObject implements MeteorFeatures{

	private Size size;
	private int randomMeteor;
	private boolean isDivided;
	
	public Meteor(Vector2D position, Vector2D dimension, Vector2D velocity, double maxVel, int randomMeteor, Size size) {
	...
	public void divideMeteor(Space space) {
